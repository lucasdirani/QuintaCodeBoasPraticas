...
using PokemonStatCalculator.Entities.Abilities.AbilityEffects.Priority;
using PokemonStatCalculator.Entities.Battles;
using PokemonStatCalculator.Entities.Types;

namespace PokemonStatCalculator.Entities.Abilities
{
    public sealed class GaleWingsAbility : Ability
    {
        ...
        public override IEnumerable<AbilityEffect> GetAbilityEffects()
        {
            ...
            {
                new MoveTypePriorityAbilityEffect(
                    moveTypesWithPriority: new List<PokemonType> { PokemonType.Flying, },
                    priorityBoostedLevel: 1,
        ...
        {
            return PokemonAbility.GaleWings;
        }
