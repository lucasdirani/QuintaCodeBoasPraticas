...
{
    public sealed class IceBeamMove : Move
    {
        public override PokemonMove MoveName { get; protected set; } = PokemonMove.IceBeam;
        ...
        public override IEnumerable<MoveEffect> MoveEffects { get; protected set; } = GetIceBeamMoveEffects();

        public override MoveUsageType MoveUsageType { get; protected set; } = MoveUsageType.None;

        private static IEnumerable<MoveEffect> GetIceBeamMoveEffects()
        {
