...
{
    public sealed class FleurCannonMove : Move
    {
        public override PokemonMove MoveName { get; protected set; } = PokemonMove.FleurCannon;
        ...
        public override IEnumerable<MoveEffect> MoveEffects { get; protected set; } = GetFleurCannonMoveEffects();

        public override MoveUsageType MoveUsageType { get; protected set; } = MoveUsageType.None;

        private static IEnumerable<MoveEffect> GetFleurCannonMoveEffects()
        {
