...
{
    public sealed class AcrobaticsMove : Move
    {
        public override PokemonMove MoveName { get; protected set; } = PokemonMove.Acrobatics;
        ...
        public override int MovePower { get; protected set; } = 55;
        ...
        public override IEnumerable<MoveEffect> MoveEffects { get; protected set; } = GetAcrobaticsMoveEffects();

        public override MoveUsageType MoveUsageType { get; protected set; } = MoveUsageType.None;

        private static IEnumerable<MoveEffect> GetAcrobaticsMoveEffects()
        {
            return new List<MoveEffect>
            {
                new NoHeldItemPowerUpMoveEffect(
